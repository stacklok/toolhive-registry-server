...
func (m *MockRegistryService) GetRegistry(ctx context.Context) (*types.Registry, string, error) {
	m.ctrl.T.Helper()
...
func (m *MockRegistryService) GetServer(ctx context.Context, name string) (types.ServerMetadata, error) {
	m.ctrl.T.Helper()
...
func (m *MockRegistryService) ListServers(ctx context.Context) ([]types.ServerMetadata, error) {
	m.ctrl.T.Helper()
