...
// FileSyncManager is the default implementation of Manager
...
// NewFileSyncManager creates a new FileSyncManager
func NewFileSyncManager(
	sourceHandlerFactory sources.SourceHandlerFactory, storageManager sources.StorageManager) *FileSyncManager {
...
func (s *FileSyncManager) ShouldSync(
	ctx context.Context,
	cfg *config.Config,
...
func (*FileSyncManager) isSyncNeededForState(syncStatus *status.SyncStatus) bool {
...
func (*FileSyncManager) isFilterChanged(ctx context.Context, cfg *config.Config, syncStatus *status.SyncStatus) bool {
...
func (s *FileSyncManager) PerformSync(
...
func (s *FileSyncManager) Delete(ctx context.Context, cfg *config.Config) error {
...
func (s *FileSyncManager) fetchAndProcessRegistryData(
	ctx context.Context,
...
func (s *FileSyncManager) applyFilteringIfConfigured(
	ctx context.Context,
	cfg *config.Config,
...
func (s *FileSyncManager) storeRegistryData(
	ctx context.Context,
	cfg *config.Config,
	fetchResult *sources.FetchResult) *Error {
	ctxLogger := log.FromContext(ctx)
